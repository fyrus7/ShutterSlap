...
*
* The function of this pad is to send a Midi CC to [MIDI2LR](https://rsjaffe.github.io/MIDI2LR/) plugin like you would with a midi controller. So make sure you install the plugin first.
